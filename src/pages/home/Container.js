  ...
  return (
    <>
      ...
      <div style={{ backgroundImage: `url(${cttCover})`, padding: "3rem" }}>
        <Row>
          ...
          >
            ...
            >
              DONATE TO RECIEVE MORE VALUE FROM US
            </h2>
          </Col>
        </Row>
      </div>
      <Row>
        ...
        >
          <Card
            style={{ margin: "auto", borderRadius: "2em", maxWidth: "100vw" }}
          >
            <p
              style={{
                color: "#656565",
            ...
            >
              Join us every week for a lively discussion on the latest in Web3
              and blockchain technology.
              <br /> From decentralized finance to NFTs, we'll dive into the
              most exciting developments shaping the future of the internet.
              <br /> Get ready for a thought-provoking and informative listen!
            </p>
            ...
            <Row>
              <Col style={{ display: "flex", justifyContent: "center" }}>
                <Button
                  style={{
                    backgroundColor:
                      donationAmount === 1000 ? oneTimeAmtBg : "#666",
                    color: "#fff",
                    height: "2.5rem",
                    fontWeight: "700",
                  }}
              ...
              <Col style={{ display: "flex", justifyContent: "center" }}>
                <Button
                  style={{
                    backgroundColor:
                      donationAmount === 500 ? oneTimeAmtBg : "#666",
                    color: "#fff",
                    height: "2.5rem",
                    fontWeight: "700",
                  }}
              ...
              <Col style={{ display: "flex", justifyContent: "center" }}>
                <Button
                  style={{
                    overflowWrap: "break-word",
                    backgroundColor:
                      donationAmount === 200 ? oneTimeAmtBg : "#666",
                    color: "#fff",
                    height: "2.5rem",
                    fontWeight: "700",
                  }}
              ...
              <Col style={{ display: "flex", justifyContent: "center" }}>
                <Button
                  style={{
                    overflowWrap: "break-word",
                    backgroundColor:
                      donationAmount === 100 ? oneTimeAmtBg : "#666",
                    color: "#fff",
                    height: "2.5rem",
                    fontWeight: "700",
                  }}
              ...
              <Col style={{ display: "flex", justifyContent: "center" }}>
                <Button
                  style={{
                    overflowWrap: "break-word",
                    backgroundColor:
                      donationAmount === 50 ? oneTimeAmtBg : "#666",
                    color: "#fff",
                    height: "2.5rem",
                    fontWeight: "700",
                  }}
              ...
              <Col style={{ display: "flex", justifyContent: "center" }}>
                <Button
                  style={{
                    overflowWrap: "break-word",
                    backgroundColor:
                      donationAmount === "others" ? oneTimeAmtBg : "#666",
                    color: "#fff",
                    height: "2.5rem",
                    fontWeight: "700",
                  }}
          ...
          >
            <h2 style={{ color: "#656565", textAlign: "right" }}>
              One Time Donation
            </h2>
            <p style={{ color: "#666" }}>
              Support us with a one time donation. Donations above $50 get a
              special shoutout on the show. Donations above $200 will
              automatically become associate producers
            </p>
            <Button
              style={{
                margin: "1rem",
          ...
          >
            <h2 style={{ color: "#656565", textAlign: "center" }}>
              Knighthood
            </h2>
            <p style={{ color: "#666" }}>
              $1000 will get you seated at the roundtable with the rest of the
              glorious Knights of the realm. You also get a Sir/Dame title
              prepended to your name
            </p>
          ...
          >
            <h2 style={{ color: "#656565", textAlign: "left" }}>
              Knight Layaway Plan
            </h2>
            <p style={{ color: "#666" }}>
              This is our original 20 month program whereby you can obtain your
              Knighthood with a monthly $50 donation for 20 months. Click here
              for that.
            </p>
        ...
        >
          ...
          >
            <h3>Weekly</h3>
            <p style={{ color: "#666" }}>
              We are offering you tons of value for just $4 a week
            </p>
            <Button
              style={{
                margin: "1rem",
          ...
          >
            ...
            <p style={{ color: "#666" }}>
              Every donation above $33.33 is qualified to get a podcasting
              licence from the CTT podcast team
            </p>
            <Button
              style={{
                margin: "1rem",
          ...
          >
            <h3>Hyper Lucky 3</h3>
            <p style={{ color: "#666" }}>
              $33.33/month with a boarding pass to the Mothership
            </p>
            <Button
              style={{
                margin: "1rem",
          ...
          >
            ...
            <p style={{ color: "#666" }}>
              Get the prefix Sir/Dame added to your name. This is a very elite
              group of people
            </p>
            <div s></div>
            <Button
          ...
          >
            ...
            <p style={{ color: "#666" }}>
              Any donationabove $200 automatically becomes an executive producer
              on the podcast.
            </p>
            <div s></div>
            <Button
      ...
      >
        {donationAmount !== "others" && (
          <>
            <p>
              <b>Amount to Donate:</b> ${donationAmount}{" "}
              <span
                style={{ cursor: "pointer", color: "#c1172c" }}
                onClick={() => {
                  setDonationAmount("others");
                  setEnterPersonalDetails(false);
                  setPaymentOption("");
                ...
                >
                  ...
                  >
                    ...
                    <Radio.Button
                      ...
                      value="hbd"
                    >
                      Hive Back Dollars/HBD(Keychain)
                    </Radio.Button>
                    <Radio.Button
                      style={{
                        overflowWrap: "break-word",
      ...
      >
        <Radio.Group
          defaultValue={paymentOption}
          buttonStyle="solid"
          onChange={onChoosePlanRadioChange}
          value={recDonationPlan}
          style={{ width: "100%" }}
        >
          <Space direction="vertical" style={{ width: "100%" }}>
            <Radio.Button
              style={{ overflowWrap: "break-word", height: "fit-content" }}
              value={"weekly"}
            >
              Weekly($4 per week)
            </Radio.Button>
            ...
            <Radio.Button
              ...
              value={"knighthood"}
            >
              Knighthood($1000 for a 20 month long support)
            </Radio.Button>
            <Divider />
          </Space>
        </Radio.Group>
          ...
          >
            ...
            >
              ...
              >
                <Input
                  onChange={(e) => {
                    setDonorFullName(e.target.value);
                  }}
                />
              </Form.Item>
              <Form.Item
              ...
              >
                <Input
                  onChange={(e) => {
                    setDonorHiveUsername(e.target.value);
                  }}
                />
              </Form.Item>
              <Form.Item
      ...
      <Modal open={hivePayModal}>
        ...
        <form action="https://hivepay.io/pay/" method="post">
          ...
          <input
            type="hidden"
            name="item_name"
            value="CTT Podcast Donations Testing"
          />
          <input
            type="hidden"
            name="description"
          ...
          <input
            type="hidden"
            name="pay_currency"
            value="CTP,HIVE,LEO,TOP10T"
          />
          <input
            type="hidden"
            name="merchant_name"
            value="Community Token Talk Podcast Test"
          />
          <input
            type="hidden"
            name="cancel_url"
          ...
          <input
            type="image"
            src="https://hivepay.io/buttons/1.png"
            alt="Buy With HivePay"
            target="_blank"
          />
        </form>
      </Modal>
